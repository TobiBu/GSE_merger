...
%%%%%%%%%%%%%%%%%% FIGURE 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
    \script{merger_ratio.py}
    \begin{centering}
        \includegraphics[width=\columnwidth]{figures/279e12_gas_mass.pdf}
        \caption{
            Gas mass as a function of time for the main progenitor galaxy (blue line). In addition we show in orange the merger ration in gas for the most massive merging satellite at each timestep (right axis).
        }
