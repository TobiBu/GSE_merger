...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{
            Relative change in cold gas surface density profile before and after the merger events. Outside of a radius of $\sim5$ kpc the merging satellites contribute cold gas up to a factor of 4 in surface density.
        }
        \label{fig:surf_den}
    \end{centering}
\end{figure}
