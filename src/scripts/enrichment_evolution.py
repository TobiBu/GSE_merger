...
axl.plot(times[2:-2], np.convolve((np.asarray(middle2)-np.asarray(central)), np.ones(N)/N, mode='valid') , label='$3<R<5\, \mathrm{kpc}$', color=color[6])
axl.plot(times[2:-2], np.convolve((np.asarray(middle)-np.asarray(central)), np.ones(N)/N, mode='valid'), label='$7<R<9\, \mathrm{kpc}$', color=color[4])
...
axl.text(6,0.1,'g2.79e12',fontsize=30)
...
ax1l.plot(times[2:-2], np.convolve((np.asarray(middle2)-np.asarray(central)), np.ones(N)/N, mode='valid') , label='$3<R<5\, \mathrm{kpc}$', color=color[6])
ax1l.plot(times[2:-2], np.convolve((np.asarray(middle)-np.asarray(central)), np.ones(N)/N, mode='valid'), label='$7<R<9\, \mathrm{kpc}$', color=color[4])
...
ax1l.text(6,0.1,'g8.26e11',fontsize=30)
...
ax2l.plot(times[2:-2], np.convolve((np.asarray(middle2)-np.asarray(central)), np.ones(N)/N, mode='valid') , label='$3<R<5\, \mathrm{kpc}$', color=color[6])
ax2l.plot(times[2:-2], np.convolve((np.asarray(middle)-np.asarray(central)), np.ones(N)/N, mode='valid'), label='$7<R<9\, \mathrm{kpc}$', color=color[4])
...
ax2l.text(6,0.1,'g7.55e11',fontsize=30)
...
ax3l.plot(times[2:-2], np.convolve((np.asarray(middle2)-np.asarray(central)), np.ones(N)/N, mode='valid') , label='$3<R<5\, \mathrm{kpc}$', color=color[6])
ax3l.plot(times[2:-2], np.convolve((np.asarray(middle)-np.asarray(central)), np.ones(N)/N, mode='valid'), label='$7<R<9\, \mathrm{kpc}$', color=color[4])
...
ax1l.legend(ncol=4, loc=1, bbox_to_anchor=(.3,1.1))#, fontsize=24)
