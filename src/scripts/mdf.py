...
ax.hist(data_main['feh_gas'],bins=50, histtype='stepfilled', color='darkgray', range=(-3.5,-0.), density=True, label='$\mathrm{main\, galaxy\, gas}$')
ax.hist(data['feh'],bins=50, histtype='step', range=(-3.5,-0.), density=True, label='$\mathrm{merger\, galaxy\, stars}$')
...
ax.xlabel('$\mathrm{[Fe/H]}$')
ax.ylabel('$\mathrm{d} f/\mathrm{d[Fe/H]}$')
ax.ylim(0,3.8)
...
ax1.hist(data2['feh'],bins=50, histtype='step', range=(-3.5,-0.), density=True, label='$\mathrm{merger\, galaxy\, 1\, stars}$')
...
ax2.hist(data3['feh'],bins=50, histtype='step', range=(-3.5,-0.), density=True, label='$\mathrm{merger\, galaxy\, 2\, stars}$')
